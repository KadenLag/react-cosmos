...
exports.getFilePaths = undefined;
...
var getExternalFixtures = function getExternalFixtures(fixturePaths) {
  return fixturePaths.reduce(function (prev, next) {
    return [].concat((0, _toConsumableArray3.default)(prev), (0, _toConsumableArray3.default)(_glob2.default.sync(next + '/**/*.{' + _fixtureExtensions.FIXTURE_EXTENSIONS_GLOB + '}')));
  }, []);
};

var extractComponentName = function extractComponentName(filePath, rootPath) {
  var componentName = filePath.replace(new RegExp('^' + rootPath + '/?(.+)$'), '$1').replace(/\.jsx?$/, '');
...
var getMatchingFixtures = function getMatchingFixtures(fixtures, componentName, fixturesDir) {
  return fixtures.reduce(function (matchingFixtures, fixturePath) {
    var fixtureName = (0, _matchFixturePath2.default)(fixturePath, componentName, fixturesDir);
    return fixtureName ? (0, _extends4.default)({}, matchingFixtures, (0, _defineProperty3.default)({}, fixtureName, fixturePath)) : matchingFixtures;
  }, {});
};

var getFilePaths = exports.getFilePaths = function getFilePaths(_ref) {
  var _ref$componentPaths = _ref.componentPaths,
      ...
      fixturesDir = _ref$fixturesDir === undefined ? '__fixtures__' : _ref$fixturesDir,
  ...
  componentPaths.forEach(function (componentPath) {
    if (_fs2.default.lstatSync(componentPath).isFile()) {
      ...
      fixtures[componentName] = typeof getFixturePathsForComponent === 'function' ? getFixturePathsForComponent(componentName) : getMatchingFixtures([].concat((0, _toConsumableArray3.default)(_glob2.default.sync(componentDir + '/**/' + fixturesDir + '/**/*.{' + _fixtureExtensions.FIXTURE_EXTENSIONS_GLOB + '}')), (0, _toConsumableArray3.default)(extFixtures)), componentName, fixturesDir);
    } else {
      var relFixtures = _glob2.default.sync(componentPath + '/**/' + fixturesDir + '/**/*.{' + _fixtureExtensions.FIXTURE_EXTENSIONS_GLOB + '}');
      _glob2.default.sync(componentPath + '/**/*.{' + _fixtureExtensions.COMPONENT_EXTENSIONS_GLOB + '}').forEach(function (filePath) {
        ...
        fixtures[componentName] = typeof getFixturePathsForComponent === 'function' ? getFixturePathsForComponent(componentName) : getMatchingFixtures([].concat((0, _toConsumableArray3.default)(relFixtures), (0, _toConsumableArray3.default)(extFixtures)), componentName, fixturesDir);
      });
    }
  });
