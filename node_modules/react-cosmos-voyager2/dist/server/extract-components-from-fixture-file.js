...
var extractComponentsFromFixtureFile = exports.extractComponentsFromFixtureFile = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(fixturePath, rootPath) {
            ...
            fixtureNodes.forEach(function (fixtureNode) {
              ...
              try {
                ...
                if (t.isCallExpression(_fixtureBody)) {
                  var _fixtureBody$argument = (0, _slicedToArray3.default)(_fixtureBody.arguments, 1);
                ...
                filePath = isModulePath ? _path2.default.join(rootPath, importPath) : (0, _server.resolveUserPath)(_path2.default.dirname(fixturePath), importPath);
              } catch (err) {
