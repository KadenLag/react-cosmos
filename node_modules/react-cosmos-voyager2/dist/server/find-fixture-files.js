...
var findFixtureFiles = exports.findFixtureFiles = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(args) {
    ...
    var _ref2, _ref2$rootPath, rootPath, _ref2$fileMatch, fileMatch, _ref2$fileMatchIgnore, fileMatchIgnore, _ref2$exclude, exclude, excludeList, allPaths, fixturePaths, fixtureFiles, _loop, i, _ret;

    return _regenerator2.default.wrap(function _callee$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _ref2 = args || {}, _ref2$rootPath = _ref2.rootPath, rootPath = _ref2$rootPath === undefined ? process.cwd() : _ref2$rootPath, _ref2$fileMatch = _ref2.fileMatch, fileMatch = _ref2$fileMatch === undefined ? _server.defaultFileMatch : _ref2$fileMatch, _ref2$fileMatchIgnore = _ref2.fileMatchIgnore, fileMatchIgnore = _ref2$fileMatchIgnore === undefined ? _server.defaultFileMatchIgnore : _ref2$fileMatchIgnore, _ref2$exclude = _ref2.exclude, exclude = _ref2$exclude === undefined ? _server.defaultExclude : _ref2$exclude;
          ...
          case 4:
            ...
            fixturePaths = (0, _micromatch2.default)(allPaths, fileMatch, { dot: true });
            fixtureFiles = [];
