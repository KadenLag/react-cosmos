...
var PropsProxy = exports.PropsProxy = function (_Component) {
  (0, _inherits3.default)(PropsProxy, _Component);

  function PropsProxy() {
    (0, _classCallCheck3.default)(this, PropsProxy);
    return (0, _possibleConstructorReturn3.default)(this, (PropsProxy.__proto__ || Object.getPrototypeOf(PropsProxy)).apply(this, arguments));
  }
  ...
  (0, _createClass3.default)(PropsProxy, [{
    ...
    value: function render() {
      ...
      if ((0, _isRefSupported.isRefSupported)(C)) {
        return _react2.default.createElement(C, (0, _extends3.default)({}, finalProps, { ref: onComponentRef }));
      }
      return _react2.default.createElement(C, finalProps);
    }
  }]);
  return PropsProxy;
}(_react.Component);
