...
var _linkedList = require('@skidding/linked-list');
...
var Loader = exports.Loader = function (_Component) {
  ...
  function Loader(props) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (Loader.__proto__ || Object.getPrototypeOf(Loader)).call(this, props));
...
function createProxyLinkedList(userProxies) {
  return (0, _linkedList2.default)([].concat((0, _toConsumableArray3.default)(userProxies), [_PropsProxy.PropsProxy]));
}
