...
function createErrorCatchProxy() {
  var ErrorCatchProxy = function (_Component) {
    ...
    function ErrorCatchProxy() {
      ...
      return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = ErrorCatchProxy.__proto__ || Object.getPrototypeOf(ErrorCatchProxy)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
        hasError: false,
        errorMessage: ''
    ...
    (0, _createClass3.default)(ErrorCatchProxy, [{
      ...
      value: function renderNextProxy() {
        ...
        return _react2.default.createElement(nextProxy.value, (0, _extends3.default)({}, this.props, { nextProxy: nextProxy.next() }));
      }
    }]);
